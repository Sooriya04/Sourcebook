...
func (r *Repository) UpdateSettings(s models.UserSettings) error {
	query := `
	INSERT INTO user_settings (id, search_provider, max_sources, searxng_split, ddg_split, youtube_enabled, youtube_max_sources, deep_crawl_enabled, deep_crawl_limit, deep_crawl_depth, updated_at)
	VALUES ('global', ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
