...
// fetchJinaContent makes a GET request to r.jina.ai for the given URL.
func fetchJinaContent(ctx context.Context, targetURL string) (string, string, error) {
...
// ScrapeURL determines the content type of the target URL and routes appropriately.
func ScrapeURL(ctx context.Context, targetURL string) (string, string, error) {
	return fetchJinaContent(ctx, targetURL)
}
